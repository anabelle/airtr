...
describe('buildCompetitorHubEntries', () => {
    it('filters competitors to hubs at the airport', () => {
        const competitors = new Map([
            ['comp-1', makeAirline({ ceoPubkey: 'comp-1', name: 'NorthWind', icaoCode: 'NWD', hubs: ['JFK'] })],
            ['comp-2', makeAirline({ ceoPubkey: 'comp-2', name: 'Sunrise', icaoCode: 'SUN', hubs: ['LAX'] })],
        ]);
    ...
    it('allows duplicate names with distinct pubkeys', () => {
        const competitors = new Map([
            ['comp-1', makeAirline({ ceoPubkey: 'comp-1', name: 'Avianca', icaoCode: 'AVA', hubs: ['JFK'] })],
            ['comp-2', makeAirline({ ceoPubkey: 'comp-2', name: 'Avianca', icaoCode: 'AVC', hubs: ['JFK'] })],
        ]);
